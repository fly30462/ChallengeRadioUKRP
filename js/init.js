...
var radioplayer = {
	...
	consts: {
		...
		api: {
			stationList: 	'http://static.radioplayer.co.uk/v1/json/StationList',
			init: 			'http://cookie.radioplayer.co.uk/cm/',
			search: 		'http://search.radioplayer.co.uk/qp/v3/search',
			suggest: 		'http://search.radioplayer.co.uk/qp/v3/suggest',
			onAir: 			'http://search.radioplayer.co.uk/qp/v3/onair',
			pollOnAir: 		'http://np.radioplayer.co.uk/qp/v3/onair',
			onDemand: 		'http://search.radioplayer.co.uk/qp/v3/oditem',
			recommend: 		'http://search.radioplayer.co.uk/qp/v3/recommend',
			az: 			'http://search.radioplayer.co.uk/qp/v3/stations'
		},
		iframe: {
			analytics: 		'http://static.radioplayer.co.uk/v3/analytics.html'
		}
	},
