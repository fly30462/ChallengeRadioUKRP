...
radioplayer.overlay = {
	...
	init : function() {
		...
		$('.menu-container .tabs ul li').eq(0).css('width', radioplayer.lang.menu_tabs.tab_1_width)
											  .find('a span').html(radioplayer.lang.menu_tabs.tab_1_text);

		$('.menu-container .tabs ul li').eq(1).css('width', radioplayer.lang.menu_tabs.tab_2_width)
											  .find('a span').html(radioplayer.lang.menu_tabs.tab_2_text);

		$('.menu-container .tabs ul li').eq(2).css('width', radioplayer.lang.menu_tabs.tab_3_width)
											  .find('a span').html(radioplayer.lang.menu_tabs.tab_3_text);

		$('.menu-container .tabs ul li').eq(3).css('width', radioplayer.lang.menu_tabs.tab_4_width)
											  .find('a span').html(radioplayer.lang.menu_tabs.tab_4_text);
